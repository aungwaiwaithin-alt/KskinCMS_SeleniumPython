...
one_click_setup "KS-CMS-TREATMENT-001_treatments.html" "Kskin CMS — Treatments (Selenium)" || { one_click_finish 1; exit 1; }
...
r.init(
    ...
    subtitle="Staging: search, Duplicate Cleanse→draft→active, ACTIVE↔INACTIVE, view, edit",
    environment=[
...
cases = [
    ...
    (3, "Duplicate Cleanse → QA active", "Draft then Set as active", add_new_treatment),
    ...
    (7, "View created treatment", "Form name readable", check_created_treatment_value),
